      ...
      <div className='max-w-4xl mx-auto px-6 py-12'>
        ...
        <main className='space-y-20 mt-12'>
          ...
          <section id='about' className='prose prose-invert'>
            <h2>About Me</h2>
            <p>
              Hi world! <strong>Intan is here</strong>, a QA Engineer with 8+ years of experience
              in manual and automation testing (Postman, Selenium, Katalon, Cypress). Skilled in
              BDD frameworks, regression, and functional testing. Passionate about delivering
              high-quality software and improving user experience.
            </p>
            <p>
              <a
